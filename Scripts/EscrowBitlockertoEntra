# 2/8/24 - Tried linking the document that used to exist in the msendpointmgr repo, and don't see it anymore.
...
Start-Transcript -Path C:\IntuneFiles\Logs\BitlockertoAAD.log
